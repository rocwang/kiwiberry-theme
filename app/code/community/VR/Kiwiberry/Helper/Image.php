 ...
 *
 * @category   Bolevar
 * @package    VR_Kiwiberry
 * @subpackage Helper
 * @author     Denis Obukhov <roomine@bolevar.com>
 */
class VR_Kiwiberry_Helper_Image extends Mage_Catalog_Helper_Image
{
    /**
     * Crop position
     *
     ...
     *
     * @return VR_Kiwiberry_Helper_Image
     */
    ...
    {
        $this->_reset();
        $this->_setModel(Mage::getModel('vr_kiwiberry/catalog_product_image'));
